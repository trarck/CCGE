#ifndef CCGE_LAYERS_GAMEWORLD_H_
#define CCGE_LAYERS_GAMEWORLD_H_
...
class GameWorld: public yhmvc::Layer,public yhge::ISOCameraMoveDelegate
{
public:
...
#endif // CCGE_LAYERS_GAMEWORLD_H_
