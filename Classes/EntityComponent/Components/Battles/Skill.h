#ifndef CCGE_ENTITYCOMPONENT_COMPONENTS_BATTLES_SKILL_H_
#define CCGE_ENTITYCOMPONENT_COMPONENTS_BATTLES_SKILL_H_
...
#endif //CCGE_ENTITYCOMPONENT_COMPONENTS_BATTLES_SKILL_H_
